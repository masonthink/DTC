...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		LLM: LLMConfig{
			...
			PrimaryProvider:   getEnv("LLM_PRIMARY_PROVIDER", "deepseek"),
			FallbackProvider:  getEnv("LLM_FALLBACK_PROVIDER", "deepseek"),
			PrimaryModel:      getEnv("LLM_PRIMARY_MODEL", "deepseek-chat"),
			ComplexModel:      getEnv("LLM_COMPLEX_MODEL", "deepseek-chat"),
			LightModel:        getEnv("LLM_LIGHT_MODEL", "deepseek-chat"),
