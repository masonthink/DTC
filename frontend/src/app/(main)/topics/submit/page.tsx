...
const TOPIC_TYPES = [
  ...
  { value: "other", label: "其他", emoji: "💬", desc: "其他深度问题" },
];

const schema = z.object({
  agent_id: z.string().min(1, "请选择一个背景档案"),
  topic_type: z.string().min(1, "请选择问题类型"),
  title: z.string().min(5, "问题标题至少5个字").max(200),
  description: z.string().min(20, "问题描述至少20个字").max(2000),
          ...
          <div className="px-4 pt-5 space-y-5">
            ...
            <div>
              ...
              {agents && agents.length > 0 ? (
                ...
                <div className="bg-card border border-border rounded-2xl p-5 text-center">
                  <p className="text-muted-foreground text-[13px] mb-3">还没有设置背景，先去设置</p>
                  <Link
                    href="/agents/create"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="描述你的具体问题、当前思考、以及你最希望得到什么方面的分析..."
                rows={5}
        ...
        {step === 2 && (
          <div className="px-4 pt-5 space-y-4">
            ...
            <div className="bg-card border border-border rounded-2xl p-5 shadow-xs">
              <p className="text-[11px] font-semibold text-primary uppercase tracking-wider mb-3">问题预览</p>
            ...
            <div className="bg-card border border-border rounded-2xl p-5 shadow-xs">
              ...
              <div className="space-y-3">
                {[
                  { time: "T+0", label: "AI 开始准备四个分析角色" },
                  { time: "T+1min", label: "四个角色展开 4 轮深度辩论" },
                  { time: "T+5min", label: "生成你的专属分析报告" },
                ].map((item, i) => (
